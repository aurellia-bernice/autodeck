...
const AutoDeckTemplatePresets = (() => {
  ...
  const presets = {
    professional: {
      ...
      layoutSet: ['bigTitle', 'standard', 'split', 'stat', 'quote', 'minimal', 'table_matrix'],
      layoutSequence: ['bigTitle', 'standard', 'split', 'stat', 'standard', 'quote', 'table_matrix', 'split', 'minimal'],
    ...
    minimal: {
      ...
      layoutSet: ['minimal', 'centered', 'standard', 'split', 'table_matrix'],
      layoutSequence: ['minimal', 'centered', 'standard', 'split', 'table_matrix', 'minimal', 'standard'],
      voiceKey: 'minimal',
    ...
    bold: {
      ...
      layoutSet: ['bigTitle', 'stat', 'split', 'quote', 'standard', 'table_matrix'],
      layoutSequence: ['bigTitle', 'stat', 'split', 'quote', 'table_matrix', 'bigTitle', 'standard', 'stat'],
      voiceKey: 'bold',
    ...
    fun: {
      ...
      theme: 'ocean',
      defaultLayout: 'image',
      layoutSet: ['image', 'split', 'quote', 'centered', 'standard', 'table_matrix'],
      layoutSequence: ['image', 'split', 'quote', 'centered', 'standard', 'table_matrix', 'image'],
      voiceKey: 'fun',
