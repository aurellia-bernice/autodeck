...
const ProcessingScreen = ({ config, generationStatus = 'ready', generationError, activeDeckId, generationTrace, onComplete, tweaks }) => {
  ...
  const traceLabels = {
    ...
    'deck-id-created': 'Deck ID created',
    'deck-write-delayed': 'Deck write delayed',
    ...
    'client-persisting-generated-slides': 'Persisting generated slides',
    'client-persist-failed': 'Client persist failed',
    'client-deadline': 'Client deadline',
